...
def mains():                        # 메인 스크린 함수
    ...
    work=Label(main_screen,text=" 과제 LIST                                                                                                   User name: {0}".format(username1),font=("맑은고딕",16,"bold"))   
...
def manager():      # 과제 관리 창
    ...
    work=Label(manager_screen,text=" 과제 LIST                                                                                                   User name: {0}".format(username1),font=("맑은고딕",16,"bold"))   
    work.pack(anchor=NW,pady=10,padx=10)
